...
export const SinglePlanetCard = () => {
    const { idplanets } = useParams();

    const[eachCard, setEachCard] = useState({})
    const getPlanetsData = async() => {
        const response = await fetch(`https://www.swapi.tech/api/planets/${idplanets}`)
        ...
        <>
            ...
            : `https://starwars-visualguide.com/assets/img/planets/${idplanets}.jpg` } className="img-fluid rounded-start" alt="..."/>
                        ...
                        <div className="row d-flex justify-content-between"> 
                            ...
                            <div className="1Character">
                              <h3>Climate:</h3>
                                <span>{eachCard.climate}</span>
                            </div>
                            <div className="1Character">
                                <h3>Diameter:</h3>
                                <span> {eachCard.diameter}</span>
                            </div>
                            ...
                            <div className="1Character">
                                <h3>Population :</h3>
                                <span>{eachCard.population} </span>
                            </div>
                            <div className="1Character">
                                <h3>Terrain :</h3>
                                <span>{eachCard.terrain} </span>
                            </div>
                            <div className="1Character">
                                <h3>Rotation Period:</h3>
                                <span>{eachCard.rotation_period} </span>
                            </div>
                            </div>
                        </div>
                        </div>
